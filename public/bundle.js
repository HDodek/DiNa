...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchRequest = __webpack_require__(160);
	...
	var UserList = React.createClass({
		...
		updateList: function updateList(response) {
			console.log(response[0]);
			//this.setState({
			//firstName: JSON.parse(response[0].first_name)});
		},
	...
	ReactDOM.render(React.createElement(UserList, null), document.getElementById('app'));
...
/***/ function(module, exports) {
	...
	var fetchRequest = function fetchRequest(method, url, data, callback) {
